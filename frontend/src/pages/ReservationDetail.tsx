...
export default function ReservationDetail() {
  ...
  const canQr = detail.status === 'CONFIRMED' || detail.status === 'PENDING'
  ...
  return (
    <div className="max-w-lg mx-auto space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-lg font-bold text-foreground">预约详情</h1>
      </div>
      ...
      <Card className="shadow-md border">
        <CardHeader className="border-b bg-muted/20 pb-4">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <span className="text-xs font-mono text-muted-foreground">RESERVATION</span>
          ...
          <div className="space-y-3 text-sm">
            ...
            {detail.verifyTime && (
              <div className="flex items-center justify-between border-b pb-2">
                ...
                <span className="font-mono text-teal-700 font-semibold">{detail.verifyTime}</span>
              </div>
            )}
          </div>

          <div className="pt-2 space-y-2">
            <span className="text-xs font-semibold text-muted-foreground uppercase">状态进度</span>
            <div className="relative pl-6 space-y-4 border-l-2 border-primary/20 ml-2">
              ...
              {detail.status === 'VERIFIED' && (
                <div className="relative">
                  <div className="absolute -left-[31px] top-1 h-3 w-3 rounded-full bg-teal-600" />
                  <div className="text-xs font-semibold text-teal-800">已到园核销</div>
        ...
        <CardFooter className="flex flex-col gap-2.5 p-6 border-t bg-muted/10">
          {canQr && (
